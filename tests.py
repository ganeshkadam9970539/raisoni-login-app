...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='mysql://dt_admin1:admin20161@localhost/dreamteam_test'
        )
        return app
    ...
    def setUp(self):
        ...
        admin = Employee(username="admin1", password="admin20161", is_admin=True)

        # create test non-admin user
        employee = Employee(username="test_user1", password="test20161")
